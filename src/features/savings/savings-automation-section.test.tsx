...
describe("SavingsAutomationSection", () => {
  it("renders existing automation rules and summary metrics", () => {
    render(<SavingsAutomationSection />);
  ...
  it("switches to percentage strategy and requires paycheck inputs", async () => {
    ...
    expect(screen.getByText("Enter a percentage between 1 and 100.")).toBeInTheDocument();
    expect(screen.getByText("Estimate the paycheck amount.")).toBeInTheDocument();
